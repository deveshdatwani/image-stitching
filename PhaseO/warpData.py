...
if __name__ == "__main__":
    basePath = "/home/deveshdatwani/Stitching/PhaseO/Train/val2017/"
    for i in os.listdir("/home/deveshdatwani/Stitching/PhaseO/Train/val2017"):
        imagePath = basePath + i
        createImageSet(imagePath)

    with open('/home/deveshdatwani/Stitching/PhaseO/Train/Labels/trainlabel.json', 'w') as fp:
        json.dump(labels, fp)
